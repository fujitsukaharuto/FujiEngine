...
Quaternion Math::Quaternion::MatrixToQuaternion(const Matrix4x4& m) {
...
Quaternion Math::Quaternion::LookRotation(const Vector3& forward, const Vector3& up) {
...
Quaternion Math::Quaternion::FromEuler(const Vector3& euler) {
...
Vector3 Math::Quaternion::QuaternionToEuler(const Quaternion& q) {
	Vector3 euler;
