...
SplatParticleCSPipe::~SplatParticleCSPipe() {
}

void SplatParticleCSPipe::CreateRootSignature(ID3D12Device* device) {
	auto csData = dxcommon_->GetDXCompile()->CompileShaderWithReflection(kDirectoryPath_ + L"CS/Engine/SplatParticle.CS.hlsl", L"cs_6_0");
...
void SplatParticleCSPipe::CreatePSO(ID3D12Device* device) {
	HRESULT hr;
