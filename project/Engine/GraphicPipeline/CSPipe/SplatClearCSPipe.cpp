...
SplatClearCSPipe::~SplatClearCSPipe() {
}

void SplatClearCSPipe::CreateRootSignature(ID3D12Device* device) {
	auto csData = dxcommon_->GetDXCompile()->CompileShaderWithReflection(kDirectoryPath_ + L"CS/Engine/SplatClear.CS.hlsl", L"cs_6_0");
...
void SplatClearCSPipe::CreatePSO(ID3D12Device* device) {
	HRESULT hr;
